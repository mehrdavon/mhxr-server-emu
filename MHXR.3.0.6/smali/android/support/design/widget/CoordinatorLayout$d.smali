...
.method public constructor <init>(II)V
    ...
    iput p2, p0, Landroid/support/design/widget/CoordinatorLayout$d;->e:I

    iput p2, p0, Landroid/support/design/widget/CoordinatorLayout$d;->f:I
    ...
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->m:Landroid/graphics/Rect;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v2, p0, Landroid/support/design/widget/CoordinatorLayout$d;->m:Landroid/graphics/Rect;
    ...
    iget-object p1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->a:Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method private a(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)V
    ...
    :goto_0
    iput-object v1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->l:Landroid/view/View;

    iput-object v1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->k:Landroid/view/View;
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout$d;->k:Landroid/view/View;
    ...
    iget v2, p0, Landroid/support/design/widget/CoordinatorLayout$d;->f:I
...
.method private a(Landroid/view/View;I)Z
    ...
    iget p1, p1, Landroid/support/design/widget/CoordinatorLayout$d;->g:I

    invoke-static {p1, p2}, Landroid/support/v4/view/b;->a(II)I

    move-result p1

    if-eqz p1, :cond_0

    iget v0, p0, Landroid/support/design/widget/CoordinatorLayout$d;->h:I

    invoke-static {v0, p2}, Landroid/support/v4/view/b;->a(II)I
...
.method private b(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)Z
    ...
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->l:Landroid/view/View;

    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->k:Landroid/view/View;
...
# virtual methods
.method public a()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    .locals 1
...
.method public a(Landroid/support/design/widget/CoordinatorLayout$Behavior;)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->a()V
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->a:Landroid/support/design/widget/CoordinatorLayout$Behavior;

    if-eqz v1, :cond_1

    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->a:Landroid/support/design/widget/CoordinatorLayout$Behavior;

    invoke-virtual {v1, p1, p2}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->o:Z
...
.method b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/view/View;
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->k:Landroid/view/View;
...
.method b(I)Z
    ...
    :pswitch_1
    iget-boolean p1, p0, Landroid/support/design/widget/CoordinatorLayout$d;->p:Z
