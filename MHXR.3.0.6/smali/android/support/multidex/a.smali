...
.method private static a(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    new-instance p3, Landroid/support/multidex/b;

    invoke-direct {p3, p1, p2}, Landroid/support/multidex/b;-><init>(Ljava/io/File;Ljava/io/File;)V
    :try_end_4
    ...
    :try_start_5
    invoke-virtual {p3, p0, p4, v2}, Landroid/support/multidex/b;->a(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    :try_start_6
    invoke-static {v1, p2, v2}, Landroid/support/multidex/a;->a(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    :try_end_6
    ...
    invoke-virtual {p3, p0, p4, p5}, Landroid/support/multidex/b;->a(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    :goto_1
    :try_start_8
    invoke-virtual {p3}, Landroid/support/multidex/b;->close()V
    :try_end_8
