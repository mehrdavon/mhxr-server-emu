...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/media/MediaBrowserServiceCompat;->a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Landroid/os/Bundle;Landroid/os/Bundle;)V
.end annotation
...
# direct methods
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/Object;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Bundle;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->e:Landroid/support/v4/media/MediaBrowserServiceCompat;
    ...
    iput-object p6, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->d:Landroid/os/Bundle;
...
.method bridge synthetic a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->a(Ljava/util/List;)V
...
.method a(Ljava/util/List;)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->e:Landroid/support/v4/media/MediaBrowserServiceCompat;

    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat;->b:Landroid/support/v4/a/a;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/a/a;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0}, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->b()I
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->f:Landroid/support/v4/media/MediaBrowserServiceCompat$e;

    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->b:Ljava/lang/String;

    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->c:Landroid/os/Bundle;

    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$1;->d:Landroid/os/Bundle;

    invoke-interface {v0, v1, p1, v2, v3}, Landroid/support/v4/media/MediaBrowserServiceCompat$e;->a(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    :try_end_0
