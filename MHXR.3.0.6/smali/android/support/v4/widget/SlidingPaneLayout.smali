...
.field final e:Landroid/support/v4/widget/g;
...
.field private r:Landroid/support/v4/widget/SlidingPaneLayout$d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->h:I
    ...
    iput p3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->l:I
    ...
    invoke-static {p0, p3}, Landroid/support/v4/view/m;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
    ...
    invoke-static {p0, v0, p2}, Landroid/support/v4/widget/g;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/g$a;)Landroid/support/v4/widget/g;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;

    iget-object p2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;

    const/high16 p3, 0x43c80000    # 400.0f

    mul-float/2addr p3, p1

    invoke-virtual {p2, p3}, Landroid/support/v4/widget/g;->a(F)V
...
.method private a(F)V
    ...
    :cond_2
    iget v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->n:F

    const/high16 v6, 0x3f800000    # 1.0f

    sub-float v5, v6, v5

    iget v7, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:I
    ...
    iget v8, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:I
    ...
    :goto_3
    iget v6, p0, Landroid/support/v4/widget/SlidingPaneLayout;->i:I
...
.method private a(Landroid/view/View;FI)V
    ...
    invoke-static {p0, p2}, Landroid/support/v4/view/m;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method a(I)V
    ...
    iget p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:I
    ...
    iget v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->h:I
...
.method a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->r:Landroid/support/v4/widget/SlidingPaneLayout$d;
...
.method a(FI)Z
    ...
    iget-boolean p2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->m:Z
    ...
    invoke-virtual {p2, v1, p1, v2}, Landroid/support/v4/widget/g;->a(Landroid/view/View;II)Z
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/g;->f()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->j:Landroid/graphics/drawable/Drawable;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-boolean v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->m:Z
...
.method e(Landroid/view/View;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/m;->a(Landroid/view/View;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, v0, v1, v2, p1}, Landroid/support/v4/view/m;->a(Landroid/view/View;IIII)V
...
.method public getParallaxDistance()I
    ...
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:I
...
.method public getSliderFadeColor()I
    ...
    iget v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->h:I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;
    ...
    invoke-virtual {v3, v1, v4, v5}, Landroid/support/v4/widget/g;->b(Landroid/view/View;II)Z
    ...
    iget v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:F
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;

    invoke-virtual {v4}, Landroid/support/v4/widget/g;->d()I
    ...
    iget-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;

    invoke-virtual {p1}, Landroid/support/v4/widget/g;->e()V
    ...
    iput v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:F
    ...
    invoke-virtual {v4, v5, v0, v1}, Landroid/support/v4/widget/g;->b(Landroid/view/View;II)Z
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/g;->e()V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v3, v0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Landroid/support/v4/widget/g;->a(I)V
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/widget/g;->a(I)V
    ...
    :cond_8
    iget-boolean v2, v0, Landroid/support/v4/widget/SlidingPaneLayout;->m:Z

    if-eqz v2, :cond_9

    iget v2, v0, Landroid/support/v4/widget/SlidingPaneLayout;->o:I
    ...
    iget v1, v0, Landroid/support/v4/widget/SlidingPaneLayout;->o:I
    ...
    iget v3, v0, Landroid/support/v4/widget/SlidingPaneLayout;->h:I
...
.method protected onMeasure(II)V
    ...
    iput-boolean v11, v0, Landroid/support/v4/widget/SlidingPaneLayout;->m:Z

    iget-object v1, v0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;

    invoke-virtual {v1}, Landroid/support/v4/widget/g;->a()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/g;->f()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:F
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->e:Landroid/support/v4/widget/g;
    ...
    invoke-virtual {v2, v3, v1, p1}, Landroid/support/v4/widget/g;->b(Landroid/view/View;II)Z
    ...
    iput v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:F

    iput p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:F
...
.method public setPanelSlideListener(Landroid/support/v4/widget/SlidingPaneLayout$d;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->r:Landroid/support/v4/widget/SlidingPaneLayout$d;
...
.method public setParallaxDistance(I)V
    ...
    iput p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->o:I
...
.method public setShadowDrawableLeft(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->j:Landroid/graphics/drawable/Drawable;
...
.method public setSliderFadeColor(I)V
    ...
    iput p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->h:I
