...
.field private c:Landroid/support/v4/widget/g;
...
.method constructor <init>(Landroid/support/v4/widget/DrawerLayout;I)V
    ...
    new-instance p1, Landroid/support/v4/widget/DrawerLayout$d$1;

    invoke-direct {p1, p0}, Landroid/support/v4/widget/DrawerLayout$d$1;-><init>(Landroid/support/v4/widget/DrawerLayout$d;)V

    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout$d;->d:Ljava/lang/Runnable;
...
.method public a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout$d;->c:Landroid/support/v4/widget/g;

    invoke-virtual {v2}, Landroid/support/v4/widget/g;->c()Landroid/view/View;
...
.method public a(Landroid/support/v4/widget/g;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout$d;->c:Landroid/support/v4/widget/g;
...
.method public a(Landroid/view/View;FF)V
    ...
    :goto_1
    iget-object p3, p0, Landroid/support/v4/widget/DrawerLayout$d;->c:Landroid/support/v4/widget/g;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result p1

    invoke-virtual {p3, p2, p1}, Landroid/support/v4/widget/g;->a(II)Z
...
.method b()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout$d;->c:Landroid/support/v4/widget/g;

    invoke-virtual {v0}, Landroid/support/v4/widget/g;->b()I
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout$d;->c:Landroid/support/v4/widget/g;

    invoke-virtual {v4}, Landroid/view/View;->getTop()I

    move-result v5

    invoke-virtual {v1, v4, v2, v5}, Landroid/support/v4/widget/g;->a(Landroid/view/View;II)Z
...
.method public b(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/g;->a(Landroid/view/View;I)V
