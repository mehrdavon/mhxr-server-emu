...
.method constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v4/widget/b$a;->e:F

    iput v0, p0, Landroid/support/v4/widget/b$a;->f:F

    iput v0, p0, Landroid/support/v4/widget/b$a;->g:F
...
.method a(FF)V
    ...
    iput p1, p0, Landroid/support/v4/widget/b$a;->r:I

    float-to-int p1, p2

    iput p1, p0, Landroid/support/v4/widget/b$a;->s:I
...
.method a(Landroid/graphics/Canvas;FFLandroid/graphics/RectF;)V
    ...
    iget-object v3, p0, Landroid/support/v4/widget/b$a;->o:Landroid/graphics/Path;
    ...
    iget v5, p0, Landroid/support/v4/widget/b$a;->r:I

    int-to-float v5, v5

    iget v6, p0, Landroid/support/v4/widget/b$a;->p:F
    ...
    iget v4, p0, Landroid/support/v4/widget/b$a;->r:I
    ...
    iget v5, p0, Landroid/support/v4/widget/b$a;->s:I
    ...
    iget v4, p0, Landroid/support/v4/widget/b$a;->h:F
    ...
    iget-object p2, p0, Landroid/support/v4/widget/b$a;->o:Landroid/graphics/Path;

    iget-object p3, p0, Landroid/support/v4/widget/b$a;->c:Landroid/graphics/Paint;
...
.method a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v6, p0, Landroid/support/v4/widget/b$a;->a:Landroid/graphics/RectF;

    iget v0, p0, Landroid/support/v4/widget/b$a;->q:F

    iget v1, p0, Landroid/support/v4/widget/b$a;->h:F
    ...
    iget v1, p0, Landroid/support/v4/widget/b$a;->q:F
    ...
    iget p2, p0, Landroid/support/v4/widget/b$a;->e:F
    ...
    iget v1, p0, Landroid/support/v4/widget/b$a;->f:F
    ...
    iget-object v2, p0, Landroid/support/v4/widget/b$a;->d:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1, p2, v7, v6}, Landroid/support/v4/widget/b$a;->a(Landroid/graphics/Canvas;FFLandroid/graphics/RectF;)V
...
.method a([I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/b$a;->b(I)V
...
.method b(I)V
    ...
    iget-object p1, p0, Landroid/support/v4/widget/b$a;->i:[I
