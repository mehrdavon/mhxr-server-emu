...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/PagerTitleStrip$a;
    ...
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->n:[I
    ...
    invoke-static {v2, v1}, Landroid/support/v4/widget/f;->a(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(IF)V
    ...
    iput v2, p0, Landroid/support/v4/view/PagerTitleStrip;->i:I
    ...
    iput p2, p0, Landroid/support/v4/view/PagerTitleStrip;->f:I
    ...
    sget-object p2, Landroid/support/v4/view/PagerTitleStrip;->o:[I
...
.method a(IFZ)V
    ...
    iget-object v3, v0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v3}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/l;

    move-result-object v3

    invoke-virtual {v0, v1, v3}, Landroid/support/v4/view/PagerTitleStrip;->a(ILandroid/support/v4/view/l;)V
    ...
    iput-boolean v1, v0, Landroid/support/v4/view/PagerTitleStrip;->k:Z
    ...
    iget-object v5, v0, Landroid/support/v4/view/PagerTitleStrip;->b:Landroid/widget/TextView;

    invoke-virtual {v5}, Landroid/widget/TextView;->getBaseline()I

    move-result v5

    iget-object v12, v0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/widget/TextView;
    ...
    iget-object v14, v0, Landroid/support/v4/view/PagerTitleStrip;->b:Landroid/widget/TextView;
    ...
    iget-object v7, v0, Landroid/support/v4/view/PagerTitleStrip;->b:Landroid/widget/TextView;
    ...
    iget v1, v0, Landroid/support/v4/view/PagerTitleStrip;->h:I
    ...
    iget-object v3, v0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
    ...
    iput v1, v0, Landroid/support/v4/view/PagerTitleStrip;->e:F
...
.method a(ILandroid/support/v4/view/l;)V
    .locals 5
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/l;->a()I
    ...
    invoke-virtual {p2, v2}, Landroid/support/v4/view/l;->a(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/view/l;->a(I)Ljava/lang/CharSequence;
    ...
    iget-boolean p2, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Z

    if-nez p2, :cond_4

    iget p2, p0, Landroid/support/v4/view/PagerTitleStrip;->e:F
...
.method a(Landroid/support/v4/view/l;Landroid/support/v4/view/l;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/view/l;->b(Landroid/database/DataSetObserver;)V

    const/4 p1, 0x0

    iput-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->m:Ljava/lang/ref/WeakReference;

    :cond_0
    if-eqz p2, :cond_1

    iget-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {p2, p1}, Landroid/support/v4/view/l;->a(Landroid/database/DataSetObserver;)V
    ...
    iput p1, p0, Landroid/support/v4/view/PagerTitleStrip;->e:F
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILandroid/support/v4/view/l;)V
...
.method protected onAttachedToWindow()V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->a(Landroid/support/v4/view/l;Landroid/support/v4/view/l;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/support/v4/view/ViewPager$d;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->e:F
    ...
    :cond_0
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->g:I

    const/4 p3, 0x1

    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/view/PagerTitleStrip;->a(IFZ)V
...
.method protected onMeasure(II)V
    ...
    :cond_1
    iget-object p1, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/widget/TextView;
...
.method public setNonPrimaryAlpha(F)V
    ...
    iget p1, p0, Landroid/support/v4/view/PagerTitleStrip;->p:I

    shl-int/lit8 p1, p1, 0x18

    iget v0, p0, Landroid/support/v4/view/PagerTitleStrip;->f:I
