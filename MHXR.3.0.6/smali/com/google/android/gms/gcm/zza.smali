...
# static fields
.field static zzbfA:Lcom/google/android/gms/gcm/zza;
...
.method static declared-synchronized zzaX(Landroid/content/Context;)Lcom/google/android/gms/gcm/zza;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/gcm/zza;->zzbfA:Lcom/google/android/gms/gcm/zza;
    ...
    sput-object v1, Lcom/google/android/gms/gcm/zza;->zzbfA:Lcom/google/android/gms/gcm/zza;

    :cond_0
    sget-object p0, Lcom/google/android/gms/gcm/zza;->zzbfA:Lcom/google/android/gms/gcm/zza;
    :try_end_0
...
.method static zzaY(Landroid/content/Context;)Z
    .locals 4
...
.method private final zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/gcm/zza;->zze(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_2
    invoke-static {p1, v5}, Lcom/google/android/gms/gcm/zza;->zze(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v5, p1}, Lorg/a/a;-><init>(Ljava/lang/String;)V

    invoke-virtual {v5}, Lorg/a/a;->a()I
    ...
    invoke-virtual {v5, v7}, Lorg/a/a;->i(I)Ljava/lang/Object;
...
.method static zzu(Landroid/os/Bundle;)V
    .locals 6
...
.method private final zzw(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    .locals 4
    ...
    invoke-static {v0}, Lcom/google/android/gms/gcm/GcmListenerService;->zzt(Landroid/os/Bundle;)V
...
# virtual methods
.method final zzv(Landroid/os/Bundle;)Z
    .locals 9
    ...
    new-instance v6, Landroid/support/v4/app/q$c;

    iget-object v7, p0, Lcom/google/android/gms/gcm/zza;->mContext:Landroid/content/Context;

    invoke-direct {v6, v7}, Landroid/support/v4/app/q$c;-><init>(Landroid/content/Context;)V

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Landroid/support/v4/app/q$c;->a(Z)Landroid/support/v4/app/q$c;

    move-result-object v6

    invoke-virtual {v6, v4}, Landroid/support/v4/app/q$c;->a(I)Landroid/support/v4/app/q$c;
    ...
    :goto_2
    invoke-virtual {v4, v0}, Landroid/support/v4/app/q$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$c;
    ...
    invoke-virtual {v4, v1}, Landroid/support/v4/app/q$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$c;
    ...
    invoke-virtual {v4, v0}, Landroid/support/v4/app/q$c;->c(I)Landroid/support/v4/app/q$c;

    :cond_8
    if-eqz v3, :cond_9

    invoke-virtual {v4, v3}, Landroid/support/v4/app/q$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/q$c;

    :cond_9
    if-eqz v5, :cond_a

    invoke-virtual {v4, v5}, Landroid/support/v4/app/q$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/q$c;

    :cond_a
    invoke-virtual {v4}, Landroid/support/v4/app/q$c;->b()Landroid/app/Notification;
