...
.field private static final zzaAc:Lcom/google/android/gms/common/GoogleApiAvailability;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/GoogleApiAvailability;->zzaAc:Lcom/google/android/gms/common/GoogleApiAvailability;
...
.method public static getInstance()Lcom/google/android/gms/common/GoogleApiAvailability;
    ...
    sget-object v0, Lcom/google/android/gms/common/GoogleApiAvailability;->zzaAc:Lcom/google/android/gms/common/GoogleApiAvailability;
...
.method public static zza(Landroid/content/Context;Lcom/google/android/gms/internal/zzbex;)Lcom/google/android/gms/internal/zzbew;
    .locals 2
    ...
    new-instance v1, Lcom/google/android/gms/internal/zzbew;

    invoke-direct {v1, p1}, Lcom/google/android/gms/internal/zzbew;-><init>(Lcom/google/android/gms/internal/zzbex;)V

    invoke-virtual {p0, v1, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v1, p0}, Lcom/google/android/gms/internal/zzbew;->setContext(Landroid/content/Context;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/internal/zzbex;->zzpy()V

    invoke-virtual {v1}, Lcom/google/android/gms/internal/zzbew;->unregister()V
...
.method static zza(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/app/h;Ljava/lang/String;)V
...
.method private final zza(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/util/zzk;->zzaH(Landroid/content/Context;)Z
    ...
    invoke-direct {v2, p1}, Landroid/support/v4/app/q$c;-><init>(Landroid/content/Context;)V

    const v4, 0x108008a

    invoke-virtual {v2, v4}, Landroid/support/v4/app/q$c;->a(I)Landroid/support/v4/app/q$c;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/app/q$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$c;
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/app/q$c;->a(J)Landroid/support/v4/app/q$c;

    move-result-object v1

    invoke-virtual {v1, v3}, Landroid/support/v4/app/q$c;->a(Z)Landroid/support/v4/app/q$c;

    move-result-object v1

    invoke-virtual {v1, p4}, Landroid/support/v4/app/q$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/q$c;

    move-result-object p4

    invoke-virtual {p4, p3}, Landroid/support/v4/app/q$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$c;

    move-result-object p3

    invoke-virtual {p3, v0}, Landroid/support/v4/app/q$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$c;

    move-result-object p3

    invoke-virtual {p3, v3}, Landroid/support/v4/app/q$c;->b(Z)Landroid/support/v4/app/q$c;

    move-result-object p3

    new-instance p4, Landroid/support/v4/app/q$b;

    invoke-direct {p4}, Landroid/support/v4/app/q$b;-><init>()V

    invoke-virtual {p4, v0}, Landroid/support/v4/app/q$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$b;

    move-result-object p4

    invoke-virtual {p3, p4}, Landroid/support/v4/app/q$c;->a(Landroid/support/v4/app/q$d;)Landroid/support/v4/app/q$c;

    move-result-object p3

    invoke-virtual {p3}, Landroid/support/v4/app/q$c;->b()Landroid/app/Notification;
    ...
    sget-object p4, Lcom/google/android/gms/common/zzo;->zzaAu:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public getErrorDialog(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/content/Context;ILcom/google/android/gms/common/internal/zzt;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public makeGooglePlayServicesAvailable(Landroid/app/Activity;)Lcom/google/android/gms/tasks/Task;
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/internal/zzbfn;->zzp(Landroid/app/Activity;)Lcom/google/android/gms/internal/zzbfn;
    ...
    invoke-virtual {p1, v2, v0}, Lcom/google/android/gms/internal/zzbfn;->zzb(Lcom/google/android/gms/common/ConnectionResult;I)V

    invoke-virtual {p1}, Lcom/google/android/gms/internal/zzbfn;->getTask()Lcom/google/android/gms/tasks/Task;
...
.method public final zza(Landroid/app/Activity;Lcom/google/android/gms/internal/zzbff;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1
    ...
    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/zzt;->zza(Lcom/google/android/gms/internal/zzbff;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/zzt;

    move-result-object p2

    invoke-static {p1, p3, p2, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/content/Context;ILcom/google/android/gms/common/internal/zzt;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
