...
.field public static final GOOGLE_PLAY_SERVICES_VERSION_CODE:I = 0xa7ffd0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field
...
.field private static zzaAs:Z = false

.field private static zzaAt:Z = false

.field static final zzaAu:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private static final zzaAv:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/zzo;->zzaAu:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/zzo;->zzaAv:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    sget-object v1, Lcom/google/android/gms/common/zzo;->zzaAv:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/internal/zzbg;->zzaE(Landroid/content/Context;)I
    ...
    :cond_1
    invoke-static {p0}, Lcom/google/android/gms/common/util/zzk;->zzaH(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/util/zzk;->zzaJ(Landroid/content/Context;)Z
    ...
    sget-object p0, Lcom/google/android/gms/common/zzj;->zzaAm:[Lcom/google/android/gms/common/zzg;
...
.method public static zzat(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/zzo;->zzaAu:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static zzaw(Landroid/content/Context;)Z
    ...
    sget-boolean v0, Lcom/google/android/gms/common/zzo;->zzaAt:Z
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/gms/internal/zzbil;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    sget-object v3, Lcom/google/android/gms/common/zzj;->zzaAm:[Lcom/google/android/gms/common/zzg;
    ...
    sput-boolean v2, Lcom/google/android/gms/common/zzo;->zzaAs:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lcom/google/android/gms/common/zzo;->zzaAs:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    sput-boolean v2, Lcom/google/android/gms/common/zzo;->zzaAt:Z
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lcom/google/android/gms/common/zzo;->zzaAs:Z
