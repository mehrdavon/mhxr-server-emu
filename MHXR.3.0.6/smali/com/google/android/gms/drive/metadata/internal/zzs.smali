...
.method protected final synthetic zzc(Lcom/google/android/gms/common/data/DataHolder;II)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/gms/drive/metadata/internal/zzs;->zzd(Lcom/google/android/gms/common/data/DataHolder;II)Ljava/util/Collection;
...
.method protected final zzd(Lcom/google/android/gms/common/data/DataHolder;II)Ljava/util/Collection;
    ...
    invoke-direct {p3, p1}, Lorg/a/a;-><init>(Ljava/lang/String;)V

    const/4 p1, 0x0

    :goto_0
    invoke-virtual {p3}, Lorg/a/a;->a()I

    move-result v0

    if-ge p1, v0, :cond_1

    invoke-virtual {p3, p1}, Lorg/a/a;->g(I)Ljava/lang/String;
