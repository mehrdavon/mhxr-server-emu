...
.field private zzaNi:Ljava/util/concurrent/CountDownLatch;

.field zzaNj:Lcom/google/android/gms/drive/events/DriveEventService$zza;
...
.method protected constructor <init>(Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNk:Z

    const/4 v0, -0x1

    iput v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaGI:I
...
.method static synthetic zza(Lcom/google/android/gms/drive/events/DriveEventService;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/drive/events/DriveEventService;->zzsY()V

    return-void
.end method

.method static synthetic zza(Lcom/google/android/gms/drive/events/DriveEventService;Lcom/google/android/gms/internal/zzbqt;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/gms/drive/events/DriveEventService;->zza(Lcom/google/android/gms/internal/zzbqt;)V

    return-void
.end method

.method private final zza(Lcom/google/android/gms/internal/zzbqt;)V
    .locals 4
    ...
    const-string v3, "handleEventMessage: "
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/internal/zzbos;->zzx(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/internal/zzbos;->zzy(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lcom/google/android/gms/internal/zzbos;->zzy(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0, p1}, Lcom/google/android/gms/internal/zzbos;->zza(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method static synthetic zzb(Lcom/google/android/gms/drive/events/DriveEventService;)Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object p0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNi:Ljava/util/concurrent/CountDownLatch;
...
.method private final zzsY()V
    ...
    iget v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaGI:I
    ...
    :cond_0
    invoke-static {p0, v0}, Lcom/google/android/gms/common/util/zzy;->zzf(Landroid/content/Context;I)Z
...
.method public final declared-synchronized onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNj:Lcom/google/android/gms/drive/events/DriveEventService$zza;

    if-nez p1, :cond_0

    iget-boolean p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNk:Z

    if-nez p1, :cond_0

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNk:Z
    ...
    iput-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNi:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-static {p1, v0}, Lcom/google/android/gms/internal/zzbos;->zzz(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
...
.method public onChange(Lcom/google/android/gms/drive/events/ChangeEvent;)V
    ...
    invoke-static {v0, p1}, Lcom/google/android/gms/internal/zzbos;->zzy(Ljava/lang/String;Ljava/lang/String;)V
...
.method public declared-synchronized onDestroy()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNj:Lcom/google/android/gms/drive/events/DriveEventService$zza;
    ...
    iget-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNj:Lcom/google/android/gms/drive/events/DriveEventService$zza;

    invoke-virtual {v1, v0}, Lcom/google/android/gms/drive/events/DriveEventService$zza;->sendMessage(Landroid/os/Message;)Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNj:Lcom/google/android/gms/drive/events/DriveEventService$zza;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNi:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-static {v1, v2}, Lcom/google/android/gms/internal/zzbos;->zzy(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/InterruptedException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_0
    :try_start_2
    iput-object v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaNi:Ljava/util/concurrent/CountDownLatch;
