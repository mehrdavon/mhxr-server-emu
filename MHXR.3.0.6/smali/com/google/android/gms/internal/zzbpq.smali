...
.method private constructor <init>(Landroid/os/Looper;Landroid/content/Context;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/zzbpq;->mContext:Landroid/content/Context;

    return-void
.end method

.method synthetic constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/google/android/gms/internal/zzbpp;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/internal/zzbpq;-><init>(Landroid/os/Looper;Landroid/content/Context;)V
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p1, p0, Lcom/google/android/gms/internal/zzbpq;->mContext:Landroid/content/Context;

    const-string v0, "EventCallback"

    const-string v1, "Don\'t know how to handle this event"

    invoke-static {p1, v0, v1}, Lcom/google/android/gms/internal/zzbos;->zzm(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzl;->zzta()Lcom/google/android/gms/common/data/DataHolder;
    ...
    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/zzbpr;-><init>(Lcom/google/android/gms/drive/MetadataBuffer;)V

    :cond_1
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzl;->zztb()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzl;->zztc()I
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/zzn;->zztd()Lcom/google/android/gms/internal/zzbmb;

    move-result-object p1

    new-instance v0, Lcom/google/android/gms/internal/zzblz;

    invoke-direct {v0, p1}, Lcom/google/android/gms/internal/zzblz;-><init>(Lcom/google/android/gms/internal/zzbmb;)V
