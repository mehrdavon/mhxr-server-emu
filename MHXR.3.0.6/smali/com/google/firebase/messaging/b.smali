...
.method static a(Landroid/os/Bundle;)Z
    ...
    invoke-static {p0, v1}, Lcom/google/firebase/messaging/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method private final b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/b;->e:Ljava/lang/reflect/Method;
    ...
    iput-object v2, p0, Lcom/google/firebase/messaging/b;->e:Ljava/lang/reflect/Method;
...
.method static c(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/Object;
    ...
    invoke-virtual {v0, v3}, Lorg/a/a;->i(I)Ljava/lang/Object;
...
.method private final d(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/firebase/messaging/b;->b:Landroid/content/Context;
...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-static {p1, v1}, Lcom/google/firebase/messaging/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/google/firebase/messaging/b;->b:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/b;->a(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/b;->b:Landroid/content/Context;
    ...
    invoke-static {v3, v9, v8, v10}, Lcom/google/firebase/iid/o;->b(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v9, v11, v8, v10}, Lcom/google/firebase/iid/o;->b(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/b;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v3, v8}, Landroid/support/v4/app/q$c;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v1}, Landroid/support/v4/app/q$c;->a(Z)Landroid/support/v4/app/q$c;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/q$c;->a(I)Landroid/support/v4/app/q$c;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/q$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$c;
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/app/q$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$c;

    new-instance v4, Landroid/support/v4/app/q$b;

    invoke-direct {v4}, Landroid/support/v4/app/q$b;-><init>()V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/q$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/q$b;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/v4/app/q$c;->a(Landroid/support/v4/app/q$d;)Landroid/support/v4/app/q$c;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/q$c;->c(I)Landroid/support/v4/app/q$c;

    :cond_11
    if-eqz v0, :cond_12

    invoke-virtual {v3, v0}, Landroid/support/v4/app/q$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/q$c;

    :cond_12
    if-eqz v9, :cond_13

    invoke-virtual {v3, v9}, Landroid/support/v4/app/q$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/q$c;

    :cond_13
    if-eqz v10, :cond_14

    invoke-virtual {v3, v10}, Landroid/support/v4/app/q$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/q$c;

    :cond_14
    invoke-virtual {v3}, Landroid/support/v4/app/q$c;->b()Landroid/app/Notification;
